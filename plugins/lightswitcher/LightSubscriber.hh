 ...
 *
*/
#ifndef GAZEBO_PLUGINS_LIGHTSUBSCRIBER_HH_
#define GAZEBO_PLUGINS_LIGHTSUBSCRIBER_HH_
...
namespace gazebo
{
  ...
  ///
  /// \verbatim
  ///    <plugin name="lightswitcher" filename="libLightSubscriber.so">
  ///
  ...
  class GAZEBO_VISIBLE LightSubscriber : public VisualPlugin
  {
    /// \brief Constructor.
    public: LightSubscriber();
    ...
    private: void Update(ConstIntPtr &_msg);
    ...
    private: transport::SubscriberPtr lightSwitcherSub;

    /// \internal
    /// \brief Private data pointer
    private: std::unique_ptr<LightSubscriberPrivate> dataPtr;
  };
}
#endif
